# DEPRECATED: Use pangea-architectures StateBackend instead.
#
# This file is preserved for backward compatibility. New state backends should
# use Pangea::Architectures::StateBackend.build(synth, config) from the
# pangea-architectures gem, invoked via `pangea workspace` commands.
#
