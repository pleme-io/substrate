...
(defcaixa my-python-pkg
  ...
  :ci-config {:bump {:default-type "patch"} :publish {:dry-run false}}

  :workflows [:auto-release :pre-merge-gate :security-gate]

  ;; Optional: ship mkdocs to gh-pages
  :docs {:enabled true :format :mkdocs}) ;; Renders to: ;;   pyproject.toml ;;   .pleme-io-release.toml ;;   .github/workflows/*.yml
